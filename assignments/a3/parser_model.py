...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        # Define the linear layer from embeddings to hidden
        ...
        # Define the linear layer from hidden to logits
    ...
    def embedding_lookup(self, t):
        ...
        x = x.view(x.size(0), -1)  # Reshape to (batch_size, n_features * embedding_size)
